...
enum
{
    rworam_fcn_id_rworam_sync_reset = 0,
    rworam_fcn_id_rworam_write = 1,
    rworam_fcn_id_rworam_read = 2,
    rworam_fcn_id_rworam_init = 3,
    rworam_fcn_id_rworam_clear = 4,
    rworam_fcn_id_rworam_oblsort_worker = 5,
    rworam_fcn_id_oe_log_init_ecall = 6,
    rworam_fcn_id_oe_get_sgx_report_ecall = 7,
    rworam_fcn_id_oe_get_report_v2_ecall = 8,
    rworam_fcn_id_oe_verify_local_report_ecall = 9,
    rworam_fcn_id_oe_sgx_init_context_switchless_ecall = 10,
    rworam_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 11,
    rworam_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};

/**** ECALL marshalling structs. ****/
typedef struct _rworam_sync_reset_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
} rworam_sync_reset_args_t;

typedef struct _rworam_write_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _rworam_read_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _rworam_init_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _rworam_clear_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _rworam_oblsort_worker_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    size_t tid;
} rworam_oblsort_worker_args_t;
...
static void ecall_rworam_sync_reset(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    rworam_sync_reset_args_t* _pargs_in = (rworam_sync_reset_args_t*)input_buffer;
    rworam_sync_reset_args_t* _pargs_out = (rworam_sync_reset_args_t*)output_buffer;
...
static void ecall_rworam_write(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    rworam_write_args_t* _pargs_in = (rworam_write_args_t*)input_buffer;
    rworam_write_args_t* _pargs_out = (rworam_write_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->buf)
        OE_SET_IN_POINTER(buf, _pargs_in->buf_size, sizeof(uint8_t), uint8_t*);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    rworam_read_args_t* _pargs_in = (rworam_read_args_t*)input_buffer;
    rworam_read_args_t* _pargs_out = (rworam_read_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->buf)
        OE_SET_IN_OUT_POINTER(buf, _pargs_in->buf_size, sizeof(uint8_t), uint8_t*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->buf)
        OE_COPY_AND_SET_IN_OUT_POINTER(buf, _pargs_in->buf_size, sizeof(uint8_t), uint8_t*);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    rworam_init_args_t* _pargs_in = (rworam_init_args_t*)input_buffer;
    rworam_init_args_t* _pargs_out = (rworam_init_args_t*)output_buffer;
...
static void ecall_rworam_clear(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    rworam_clear_args_t* _pargs_in = (rworam_clear_args_t*)input_buffer;
    rworam_clear_args_t* _pargs_out = (rworam_clear_args_t*)output_buffer;
...
static void ecall_rworam_oblsort_worker(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    rworam_oblsort_worker_args_t* _pargs_in = (rworam_oblsort_worker_args_t*)input_buffer;
    rworam_oblsort_worker_args_t* _pargs_out = (rworam_oblsort_worker_args_t*)output_buffer;
...
oe_ecall_func_t oe_ecalls_table[] = {
    (oe_ecall_func_t) ecall_rworam_sync_reset,
    (oe_ecall_func_t) ecall_rworam_write,
    (oe_ecall_func_t) ecall_rworam_read,
    (oe_ecall_func_t) ecall_rworam_init,
    (oe_ecall_func_t) ecall_rworam_clear,
    (oe_ecall_func_t) ecall_rworam_oblsort_worker,
...
enum
{
    rworam_fcn_id_oe_log_is_supported_ocall = 0,
    rworam_fcn_id_oe_log_ocall = 1,
    rworam_fcn_id_oe_write_ocall = 2,
    rworam_fcn_id_oe_syscall_epoll_create1_ocall = 3,
    rworam_fcn_id_oe_syscall_epoll_wait_ocall = 4,
    rworam_fcn_id_oe_syscall_epoll_wake_ocall = 5,
    rworam_fcn_id_oe_syscall_epoll_ctl_ocall = 6,
    rworam_fcn_id_oe_syscall_epoll_close_ocall = 7,
    rworam_fcn_id_oe_syscall_open_ocall = 8,
    rworam_fcn_id_oe_syscall_read_ocall = 9,
    rworam_fcn_id_oe_syscall_write_ocall = 10,
    rworam_fcn_id_oe_syscall_readv_ocall = 11,
    rworam_fcn_id_oe_syscall_writev_ocall = 12,
    rworam_fcn_id_oe_syscall_lseek_ocall = 13,
    rworam_fcn_id_oe_syscall_pread_ocall = 14,
    rworam_fcn_id_oe_syscall_pwrite_ocall = 15,
    rworam_fcn_id_oe_syscall_close_ocall = 16,
    rworam_fcn_id_oe_syscall_flock_ocall = 17,
    rworam_fcn_id_oe_syscall_fsync_ocall = 18,
    rworam_fcn_id_oe_syscall_fdatasync_ocall = 19,
    rworam_fcn_id_oe_syscall_dup_ocall = 20,
    rworam_fcn_id_oe_syscall_opendir_ocall = 21,
    rworam_fcn_id_oe_syscall_readdir_ocall = 22,
    rworam_fcn_id_oe_syscall_rewinddir_ocall = 23,
    rworam_fcn_id_oe_syscall_closedir_ocall = 24,
    rworam_fcn_id_oe_syscall_stat_ocall = 25,
    rworam_fcn_id_oe_syscall_fstat_ocall = 26,
    rworam_fcn_id_oe_syscall_access_ocall = 27,
    rworam_fcn_id_oe_syscall_link_ocall = 28,
    rworam_fcn_id_oe_syscall_unlink_ocall = 29,
    rworam_fcn_id_oe_syscall_rename_ocall = 30,
    rworam_fcn_id_oe_syscall_truncate_ocall = 31,
    rworam_fcn_id_oe_syscall_ftruncate_ocall = 32,
    rworam_fcn_id_oe_syscall_mkdir_ocall = 33,
    rworam_fcn_id_oe_syscall_rmdir_ocall = 34,
    rworam_fcn_id_oe_syscall_fcntl_ocall = 35,
    rworam_fcn_id_oe_syscall_ioctl_ocall = 36,
    rworam_fcn_id_oe_syscall_poll_ocall = 37,
    rworam_fcn_id_oe_syscall_kill_ocall = 38,
    rworam_fcn_id_oe_syscall_close_socket_ocall = 39,
    rworam_fcn_id_oe_syscall_socket_ocall = 40,
    rworam_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 41,
    rworam_fcn_id_oe_syscall_socketpair_ocall = 42,
    rworam_fcn_id_oe_syscall_connect_ocall = 43,
    rworam_fcn_id_oe_syscall_accept_ocall = 44,
    rworam_fcn_id_oe_syscall_bind_ocall = 45,
    rworam_fcn_id_oe_syscall_listen_ocall = 46,
    rworam_fcn_id_oe_syscall_recvmsg_ocall = 47,
    rworam_fcn_id_oe_syscall_sendmsg_ocall = 48,
    rworam_fcn_id_oe_syscall_recv_ocall = 49,
    rworam_fcn_id_oe_syscall_recvfrom_ocall = 50,
    rworam_fcn_id_oe_syscall_send_ocall = 51,
    rworam_fcn_id_oe_syscall_sendto_ocall = 52,
    rworam_fcn_id_oe_syscall_recvv_ocall = 53,
    rworam_fcn_id_oe_syscall_sendv_ocall = 54,
    rworam_fcn_id_oe_syscall_shutdown_ocall = 55,
    rworam_fcn_id_oe_syscall_setsockopt_ocall = 56,
    rworam_fcn_id_oe_syscall_getsockopt_ocall = 57,
    rworam_fcn_id_oe_syscall_getsockname_ocall = 58,
    rworam_fcn_id_oe_syscall_getpeername_ocall = 59,
    rworam_fcn_id_oe_syscall_getaddrinfo_open_ocall = 60,
    rworam_fcn_id_oe_syscall_getaddrinfo_read_ocall = 61,
    rworam_fcn_id_oe_syscall_getaddrinfo_close_ocall = 62,
    rworam_fcn_id_oe_syscall_getnameinfo_ocall = 63,
    rworam_fcn_id_oe_syscall_nanosleep_ocall = 64,
    rworam_fcn_id_oe_syscall_clock_nanosleep_ocall = 65,
    rworam_fcn_id_oe_syscall_getpid_ocall = 66,
    rworam_fcn_id_oe_syscall_getppid_ocall = 67,
    rworam_fcn_id_oe_syscall_getpgrp_ocall = 68,
    rworam_fcn_id_oe_syscall_getuid_ocall = 69,
    rworam_fcn_id_oe_syscall_geteuid_ocall = 70,
    rworam_fcn_id_oe_syscall_getgid_ocall = 71,
    rworam_fcn_id_oe_syscall_getegid_ocall = 72,
    rworam_fcn_id_oe_syscall_getpgid_ocall = 73,
    rworam_fcn_id_oe_syscall_getgroups_ocall = 74,
    rworam_fcn_id_oe_syscall_uname_ocall = 75,
    rworam_fcn_id_oe_get_supported_attester_format_ids_ocall = 76,
    rworam_fcn_id_oe_get_qetarget_info_ocall = 77,
    rworam_fcn_id_oe_get_quote_ocall = 78,
    rworam_fcn_id_oe_get_quote_verification_collateral_ocall = 79,
    rworam_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall = 80,
    rworam_fcn_id_oe_verify_quote_ocall = 81,
    rworam_fcn_id_oe_sgx_get_cpuid_table_ocall = 82,
    rworam_fcn_id_oe_sgx_backtrace_symbols_ocall = 83,
    rworam_fcn_id_oe_sgx_log_backtrace_ocall = 84,
    rworam_fcn_id_oe_sgx_thread_wake_wait_ocall = 85,
    rworam_fcn_id_oe_sgx_wake_switchless_worker_ocall = 86,
    rworam_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 87,
    rworam_fcn_id_oe_get_tdx_quote_verification_collateral_ocall = 88,
    rworam_fcn_id_oe_verify_tdx_quote_ocall = 89,
    rworam_fcn_id_untrusted_call_max = OE_ENUM_MAX
};
    ...
    )
{
    ...
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_log_is_supported_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_epoll_create1_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int timeout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_epoll_wait_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_epoll_wake_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_epoll_wake_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_epoll_event* event)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_epoll_ctl_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t epfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_epoll_close_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_mode_t mode)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_open_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t count)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_read_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t count)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_write_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_readv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_writev_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int whence)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_lseek_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t offset)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_pread_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t offset)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_pwrite_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_close_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int operation)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_flock_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_fsync_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_fdatasync_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t oldfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_dup_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* name)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_opendir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_dirent* entry)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_readdir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_rewinddir_ocall(uint64_t dirp)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_rewinddir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t dirp)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_closedir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_stat_t* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_stat_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_stat_t* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_fstat_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int mode)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_access_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* newpath)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_link_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* pathname)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_unlink_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* newpath)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_rename_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t length)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_truncate_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t length)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_ftruncate_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_mode_t mode)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_mkdir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* pathname)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_rmdir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    void* argout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_fcntl_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    void* argout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_ioctl_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int timeout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_poll_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int signum)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_kill_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sockfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_close_socket_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int protocol)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_socket_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sockfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_shutdown_sockets_device_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sv[2])
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_socketpair_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_connect_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_accept_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_bind_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int backlog)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_listen_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_recvmsg_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_sendmsg_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_recv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_recvfrom_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_send_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_sendto_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_recvv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_sendv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int how)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_shutdown_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t optlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_setsockopt_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* optlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getsockopt_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getsockname_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getpeername_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t* handle)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getaddrinfo_open_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    char* ai_canonname)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getaddrinfo_read_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t handle)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getaddrinfo_close_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getnameinfo_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_timespec* rem)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_nanosleep_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_timespec* rem)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_clock_nanosleep_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getpid_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getpid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getppid_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getppid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getpgrp_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getpgrp_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getuid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getuid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_geteuid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_geteuid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getgid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getgid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getegid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getegid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int pid)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getpgid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    unsigned int* list)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_getgroups_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_utsname* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_syscall_uname_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    format_ids_t* format_ids)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_get_supported_attester_format_ids_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    sgx_target_info_t* target_info)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_get_qetarget_info_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* quote_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_get_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* qe_identity_issuer_chain_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_get_quote_verification_collateral_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* qe_identity_issuer_chain_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint32_t qe_identity_issuer_chain_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_verify_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t cpuid_table_buffer_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_sgx_get_cpuid_table_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* symbols_buffer_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_sgx_backtrace_symbols_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_sgx_log_backtrace_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t self_tcs)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_sgx_thread_wake_wait_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_sgx_wake_switchless_worker_ocall(oe_host_worker_context_t* context)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_sgx_wake_switchless_worker_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_sgx_sleep_switchless_worker_ocall(oe_enclave_worker_context_t* context)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_sgx_sleep_switchless_worker_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    tdx_quote_collateral_t* collateral)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_get_tdx_quote_verification_collateral_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint32_t* p_supplemental_data_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             rworam_fcn_id_oe_verify_tdx_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
